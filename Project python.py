...
def two_player():
    conn = sqlite3.connect(r"C:/Users/Admin/Desktop/Project OS/Database/Databasetest2.db")
    board = ["", " ", " ", " ", " ", " ", " ", " ", " ", " "]
    ...
    while True:
        ...
        if is_winner(board, "X"):
            ...
            print_board()
            print("Player1 Win")
            c.execute('''insert into Player1 (Win,counts) VAlUES(Null,1)''')
            conn.commit()
            c.close()
            break
        ...
        if is_winner(board, "O"):
            ...
            print_board()
            print("Player2 Win")
            c.execute('''insert into Player2 (Win,counts) VAlUES(Null,1)''')
            conn.commit()
            c.close()
            break
